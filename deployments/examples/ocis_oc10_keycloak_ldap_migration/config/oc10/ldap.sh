...
CONFIG=$(cat <<EOF
{
    "apps": {
        "user_ldap": {
            ...
            "s01ldap_agent_password": "YWRtaW4=",
            "s01ldap_attributes_for_group_search": "",
            "s01ldap_attributes_for_user_search": "uid",
            "s01ldap_backup_host": "",
            "s01ldap_backup_port": "",
            "s01ldap_base": "dc=owncloud,dc=com",
            "s01ldap_base_groups": "dc=owncloud,dc=com",
            "s01ldap_base_users": "dc=owncloud,dc=com",
            "s01ldap_cache_ttl": "600",
            "s01ldap_configuration_active": "1",
            "s01ldap_display_name": "displayName",
            "s01ldap_dn": "cn=admin,dc=owncloud,dc=com",
            ...
            "s01ldap_login_filter": "(&(|(objectclass=owncloud))(|(uid=%uid)(|(dc=%uid))))",
            ...
            "s01ldap_userlist_filter": "(objectclass=owncloud)",
